...
export const helpCommand: Command = new Command()
    .command("help")
    .description("command to see list of available commands")
    .action(() => {
      ...
      console.log(`to see list of your expense use "expense-tracker list"`);
      console.log(`to see how much your expense use "expense-tracker summary"`);
      ...
      console.log(`if you want to see some specific args like --add etc for specific command use "expense-tracker summary --help"`);
    })
